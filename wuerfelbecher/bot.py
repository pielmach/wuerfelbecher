...
def get_bot_token(secret_path: str, environment_variable: str) -> str:
    ...
    if os.path.exists(secret_path):
        ...
        print("Failed to find access token for discord bot at {} or environment variable {}".format(
            secret_path, environment_variable))
        raise RuntimeError("Failed to find access token for discord bot at {} or environment variable {}".format(
            secret_path, environment_variable))
